...
<body>
    ...
    <div class="bg-black">
        ...
        <form action="#" method="GET">
            ...
            <button type="submit" value="searchTarget" name="searchT" class="mt-2 p-2 rounded-lg bg-blue-600 hover:bg-gradient-to-r from-cyan-500 to-blue-500 text-white" style="cursor: pointer">Search</button>
            <br>
        </form>
        <br>
        ...
        <div class="">
            ...
            try {
                ...
                foreach ($pdo->query($sql) as $target) {
                    ...
                    echo '<button type="submit" value="' . $target['id'] . '" name="update" class="mt-2 p-2 rounded-lg bg-green-600 hover:bg-gradient-to-r from-lime-300 to-green-500 text-white" style="cursor: pointer;">';
                    echo 'Update';
                    echo '</button>';
                    echo '</form>';
                    echo '<form action="#" method="POST">';
                    echo '<button type="submit" value="' . $target['id'] . '" name="deleteCible" class="mt-2 p-2 rounded-lg bg-red-600 hover:bg-gradient-to-r from-orange-500 to-red-700 text-white" style="cursor: pointer;">';
                    echo 'Delete';
                    echo '</button>';
                    echo '</form>';
                    echo "</div>";
