    ...
    <div class="bg-black">
        ...
        <div class="grid justify-items-stretch">
            <div class="justify-self-center">
                <a href="gestionCible.php" class="font-medium px-3 py-2 text-slate-700 rounded-lg hover:text-slate-900 bg-white-600 hover:bg-sky-600"><i class="fa-solid fa-plus"></i>Ajouter Cible</a>
            </div>
        </div>
        <br>
        ...
        <div class="">
            ...
            try {
                ...
                foreach ($pdo->query('SELECT * FROM targets') as $target) {
                    ...
                    echo '<br>';
                    echo "Prénom: " . $target['firstname'];
                    echo "<br>";
                    echo "Date de naissance: " . $target['date_of_birth'];
                    echo "<br>";
                    echo "Code Agent: " . $target['codeName'];
                    echo "<br>";
                    echo "Nationalité: ";
                    echo "<br>";
