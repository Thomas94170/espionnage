...
<div class="">
    <div class="bg-black">
        <nav class="flex justify-center space-x-4">
            ...
            <a href="logout.php" type="submit" class="font-medium px-3 py-2 text-slate-700 rounded-lg hover:bg-yellow-400 hover:text-slate-900"><i class="fa-solid fa-power-off"></i>Déconnexion</a>
        </nav>
